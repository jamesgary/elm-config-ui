...
var author$project$Config$empty = function (defaults) {
	return {configFontSize: defaults._int, configInputHeight: defaults._int, configLabelHighlightBgColor: defaults.color, configRowSpacing: defaults._int, configTableBgColor: defaults.color, configTableBorderColor: defaults.color, configTableBorderWidth: defaults._int, configTablePadding: defaults._int, headerFontSize: defaults._int, headerString: defaults.string, showSubheaders: defaults.bool, subheaderColor: defaults.color, subheaderFontSize: defaults._int, subheaderNum: defaults._int, subheaderPadding: defaults._int, subheaderString: defaults.string};
};
var author$project$ConfigForm$BoolLogic = F2(
	function (a, b) {
		return {$: 'BoolLogic', a: a, b: b};
	});
var author$project$ConfigForm$bool = F4(
	function (fieldName, label, getter, setter) {
		return {
			fieldName: fieldName,
			kind: A2(author$project$ConfigForm$BoolLogic, getter, setter),
			label: label
		};
	});
...
var author$project$ConfigForm$StringLogic = F2(
	function (a, b) {
		return {$: 'StringLogic', a: a, b: b};
	});
var author$project$ConfigForm$string = F4(
	function (fieldName, label, getter, setter) {
		return {
			fieldName: fieldName,
			kind: A2(author$project$ConfigForm$StringLogic, getter, setter),
			label: label
		};
	});
...
var author$project$Config$logics = _List_fromArray(
	[
		...
		A4(
		author$project$ConfigForm$string,
		'headerString',
		'Header string',
		function ($) {
			return $.headerString;
		...
		A4(
		author$project$ConfigForm$bool,
		'showSubheaders',
		'Show subheaders',
		function ($) {
		...
		author$project$ConfigForm$section('Config'),
		A4(
		author$project$ConfigForm$int,
		'configRowSpacing',
		'Row spacing',
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$text('Header: ' + model.config.headerString)
						])),
					model.config.showSubheaders ? A2(
					mdgriffith$elm_ui$Element$column,
					_List_Nil,
					A2(
						elm$core$List$map,
						function (_n0) {
							return A2(
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$Font$size(model.config.subheaderFontSize),
										mdgriffith$elm_ui$Element$Background$color(
										author$project$Main$colorForE(model.config.subheaderColor)),
										mdgriffith$elm_ui$Element$padding(model.config.subheaderPadding)
									]),
								mdgriffith$elm_ui$Element$text('Subheader: ' + model.config.subheaderString));
						},
						A2(elm$core$List$range, 1, model.config.subheaderNum))) : mdgriffith$elm_ui$Element$none
				])));
};
